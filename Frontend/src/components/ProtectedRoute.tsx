...
import { getActiveUser, getStoredSessionToken, ROLE_DEFAULT_ROUTES } from '../cryptography/cryptoSession';
...
export const ProtectedRoute: React.FC<ProtectedRouteProps> = ({ allowedRoles, children }) => {
  ...
  // If no user profile or valid session exists, redirect to /login
